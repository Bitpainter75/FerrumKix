...
Namespace Services
    ...
    ''' so, wie der Desktop es vorgibt. Uebernommen aus FerrumPix, Zeile fuer Zeile: beide
    ''' Anwendungen zeichnen dieselbe Titelleiste und sollen sich auch gleich verhalten.
    '''
    ''' FerrumKix zeichnet seine Titelleiste selbst (WindowDecorations="None" in MainWindow.axaml),
    ''' und selbst gezeichnete Knoepfe erben keine Anordnung. Wer seinen Arbeitsplatz auf Knoepfe
    ''' links eingerichtet hat, greift bei uns ins Leere - deshalb diese Abfrage.
    '''
    ''' **DIE ANORDNUNG DES DESKTOPS BESTIMMT DIE REIHENFOLGE, NICHT DEN BESTAND.** Sie sagt
    ''' naemlich beides: GNOME steht seit Jahren ab Werk auf "appmenu:close", nennt also nur EINEN
    ''' Fensterknopf. Wer das woertlich uebernaehme, naehme dem Grossteil der GNOME-Anwender
    ''' Minimieren und Maximieren weg - und unsere Leiste ist der einzige Weg dorthin. Genannte
    ''' Knoepfe kommen deshalb in der genannten Reihenfolge, nicht genannte haengen hinten an.
    ''' </summary>
    Public NotInheritable Class WindowButtonSideService
        ...
        ''' <summary>Die Reihenfolge, die FerrumKix ohne Antwort des Desktops nimmt, von links nach
        ...
        ''' rechts. Unsere Leiste hat nur EINEN Knopfblock, und der Namenszug sitzt auf der freien
        ''' Seite; geteilt gaebe es keine freie Seite mehr. Die Knoepfe bleiben deshalb zusammen und
        ''' gehen dorthin, wo die Mehrheit von ihnen steht - der Rest haengt in der Werksreihenfolge
        ''' an.</summary>
